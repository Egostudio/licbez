...
<div class="center">
    <ul class="pagination{if $ajax} fn_is_ajax{/if} clearfix">
        ...
        {if $current_page_num > 1}
            <li class="page_item">
                <a class="page_link" href="{if $current_page_num == 2}{furl page=null}{else}{furl page=$current_page_num - 1}{/if}" title="{$lang->pagination_prev}">
                    <span>&laquo;</span>
                </a>
            </li>
        {/if}
        ...
        {if $current_page_num < $total_pages_num}
            <li class="page_item">
                <a class="page_link" href="{furl page=$current_page_num+1}" title="{$lang->pagination_next}">
                    <span>&raquo;</span>
                </a>
            </li>
        {/if}
