        ...
        <div class="wrap_heading">
            ...
            {if $category->id}
                <div class="box_btn_heading">
                    <a class="btn btn_small btn-info add" target="_blank" href="../{$lang_link}category/{$category->url}">
            ...
            <div class="boxed match fn_toggle_wrap tabs">
                <div class="heading_tabs">
                    <div class="tab_navigation">
                        ...
                        <a href="#tab3" class="tab_navigation_link">{$btr->general_additional_description|escape}</a>
                    </div>
                    <div class="toggle_arrow_wrap fn_toggle_card text-primary">
                ...
                <div class="toggle_body_wrap on fn_card ">
                    <div class="tab_container">
                        ...
                        <div id="tab3" class="tab">
                            <textarea name="description_top1" class="editor_large fn_editor_class">{$category->description_top1|escape}</textarea>
                            <textarea name="description_top2" class="editor_large fn_editor_class">{$category->description_top2|escape}</textarea>
                            <textarea name="description_bottom" class="editor_large fn_editor_class">{$category->description_bottom|escape}</textarea>
                        </div>
