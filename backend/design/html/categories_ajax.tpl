        ...
        <div class="fn_row">
            <div class="okay_list_row fn_sort_item">
                ...
                <div class="okay_list_setting">
                    {*open*}
                    <a href="{$lang_link}../category/{$ajax_category->url|escape}" target="_blank" data-hint="{$btr->general_view|escape}" class="setting_icon setting_icon_open hint-bottom-middle-t-info-s-small-mobile  hint-anim">
