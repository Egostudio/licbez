...
require_once('lib/Slugify.class.php');
...
//Savchuk
            $url = trim($this->request->post('url', 'string'));
            $category->url = SlugifyClass::Slugify($url);
            ...
            $category->description_top1 = $this->request->post('description_top1');
            $category->description_top2 = $this->request->post('description_top2');
            $category->description_bottom = $this->request->post('description_bottom');
