...
class Languages extends Okay {
    ...
    public function get_fields($object = '') {
        $fields['categories']      = array('name', 'name_h1', 'meta_title', 'meta_keywords', 'meta_description', 'annotation', 'description', 'description_top1', 'description_top2','description_bottom','auto_meta_title', 'auto_meta_keywords', 'auto_meta_desc', 'auto_description');
...
//$message = 'lang_id new 4 = '.$this->first_language->id;
//mail('iv.savchuk@gmail.com', 'the subject', $message);
    }
